...
The subsequent [typed Setup component increment](setup-components.md) connects these services and updates distribution for the core assembly. Live host validation and downstream simulation migration remain outstanding.

...
2. For every FlahaGrow node, record its GUID, input/output index, persistent data, and wire sources. Compare this with the [migration guide](../components/migration.md) and the I/O audit.

...
Use [component-migration.md](../components/migration.md) for practical wiring and compatibility policy, [current-status.md](../quality/current-status.md) for implemented/open work, and [annual-result-audit-2026-09-10.md](annual-result-audit-2026-09-10.md) for the real study/cache findings.

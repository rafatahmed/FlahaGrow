...
Electric Annual Simulation is `1.0.0` (2026-09-11 19:45 +03:00): it runs a background full-output electric Radiance calculation, snapshots its dimming schedule, and writes a manifest-owned result. `DLI Hourly` is `1.0.1` (2026-09-11 21:15 +03:00): it validates and reads the selected 24-hour block once rather than re-validating the entire cache for every sensor. `DLI Each Sensor` is `1.0.1` (2026-09-11 20:58 +03:00): it fixes its native Generic sensor-point tree read. Spectral parity remains an open host/reference validation gate. The catalog source remains the complete ledger.

The initial tracking baseline is `1.0.1` (2026-09-11 12:48 +03:00). Working Directory is `1.0.2` (2026-09-11 12:50 +03:00). Annual Simulation is `1.6.0` (2026-09-11 19:20 +03:00): strict Ladybug-compatible EPW-to-WEA conversion, the verified 146-column ground-plus-sky receiver basis, a compatible `Keep` input, disk preflight/cleanup, and verified persisted-process cancellation. Annual Simulation Progress is `1.1.0` (2026-09-11 16:10 +03:00): per-part 1–8 stages and stage coverage. Annual cache readers are `1.1.0` (2026-09-11 18:05 +03:00): manifest/signature/cache-hash provenance is mandatory. The catalog source is the complete ledger.
